...
public class KanbanTimetrack extends KanbanApp{
	 ...
	 public WebDriver sesiune() {
		 	System.setProperty("webdriver.gecko.driver", "D:\\DS_Builds\\Other\\geckodriver.exe");
	...
	public KanbanTimetrack() {	
		...
		int voltaNs = driver.findElements(By.xpath("//*[text()='NightShift']")).size();
		if (voltaNs > 1) {
			driver.findElement(By.xpath("//*[text()='NightShift']")).click();
			wait.until(ExpectedConditions.refreshed(ExpectedConditions.elementToBeClickable(By.cssSelector("a[title='Assign to me ']")))).click();
		} 
		else {
			wait.until(ExpectedConditions.refreshed(ExpectedConditions.elementToBeClickable(By.cssSelector("a[title='Assign to me ']")))).click();
		}
